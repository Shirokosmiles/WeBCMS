...
$title = 'Проверка!';
$content = '<ol>
	<li><strong>Проверка тестового редактора!</strong></li>
	<li><strong>Проверка работы редактора</strong></li>
	<li><strong>Тест</strong></li>
</ol>
';
$author = 'INDRA';
$created_at = '16 Oct';
...
$thumbnail = '../uploads/news/670fdfa5dda5c2024-10-16_21-31-24.png';
$url = '../news/proverka.php';
?>
