...
!function(p, x) {
    ...
    p.Copied = function() {
        ...
        function t(e, t) {
            ...
            n.addClass("success" === t ? i : s).find(o).html(e),
            setTimeout(function() {
                n.removeClass(i + " " + s).find(o).html(a.text).blur(),
                n.find("input").blur()
            }, 2e3)
        }
    ...
    p.Toast = function(e, t, n) {
        ...
        n.ui = n.ui ? " " + n.ui : "",
        o = "" !== n.icon ? '<span class="toastr-icon"><em class="icon ' + n.icon + '"></em></span>' : "",
        "" !== (e = "" !== e ? o + '<div class="toastr-text">' + e + "</div>" : "") && (!0 === n.clear && toastr.clear(),
        a = {
            closeButton: !0,
            debug: !1,
            newestOnTop: !1,
    ...
    p.TGL.content = function(e, t) {
        ...
        c.on("mouseup", function(e) {
            ...
            t.is(e.target) || 0 !== t.has(e.target).length || n.is(e.target) || 0 !== n.has(e.target).length || 0 !== x(e.target).closest(".select2-container").length || a.is(e.target) || 0 !== a.has(e.target).length || o.is(e.target) || 0 !== o.has(e.target).length || (p.Toggle.removed(t.data("target"), s),
            i = !1))
        }),
        r.on("resize", function() {
            n.each(function() {
    ...
    p.TGL.showmenu = function(e, t) {
        ...
        n.on("click", function(e) {
            p.Toggle.trigger(x(this).data("target"), i),
            e.preventDefault()
        }),
        c.on("mouseup", function(e) {
        ...
        r.on("resize", function() {
            (p.Win.width < d.xl || p.Win.width < o) && p.Toggle.removed(n.data("target"), i)
        })
    }
    ,
    ...
    p.Custom.Stepper = function(n, e) {
        var t = !(!n.dataset.stepInit || isNaN(n.dataset.stepInit)) && parseInt(n.dataset.stepInit)
          ...
          , i = (n.querySelector(".".concat(t.selectors.progress)),
        ...
        function y(e) {
            ...
            b && (i.innerHTML = "".concat(e, " of ").concat(h),
        ...
        r.querySelector("button").addEventListener("click", function(e) {
            ...
            o[t].classList.add(f)) : (v && a[t].classList.remove(p),
            o[t].classList.remove(f)),
            y(--g)
        }),
