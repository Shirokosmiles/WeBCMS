    ...
    <head>
        ...
        <body>          
            <div class="character-select">
                <form method="post" action="alterac-pvp.online/chars/main/index.php">
                    <label for="Characters">Выберите персонажа:</label> 
                    <select name="charid" id="Characters">
                    <option value="\"></option>  
                        <!-- Add Load Character List PHP Here -->
                        <?php
                        if ($result = mysqli_query($itemcon, "SELECT * FROM characters WHERE account > 502 ORDER BY name ASC")) {
                ...
                <div class="grid-item item-name">
                    <div class="grid-container-main">
                        ...
                        <div class="grid-container-main-info">
                            ...
                            <div class="grid-item-main-info"><?php if($info_level != null){echo "Уровень ".$info_level;} ?></div>
                        </div>
                        </div>
